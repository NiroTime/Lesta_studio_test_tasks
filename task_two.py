class CyclesQueueListItem:
    """
    Фабрика объектов для реализации циклического буфера через Связанный список.
    """
...
class CyclesQueueList:
    """
    Циклический буфер, реализованный с помощью связанных списков.
    """
...
class CyclesQueue:
    """
    Циклический буфер, реализованный с помощью индексов.
    """
    def __init__(self, size):
        self._items = [0] * size
        self._head = 0
